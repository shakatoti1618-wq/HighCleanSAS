...
- **Resend**: sender `onboarding@resend.dev` hasta dominio propio (M17). ⚠️ Con ese sender Resend **solo entrega al correo dueño de la key**, así que en dev `NOTIFY_EMAIL` debe ser ese correo para probar.
